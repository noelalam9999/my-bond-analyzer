/**
 * Live mark-to-market data from Bangladesh Bank's GSOM T-bond page.
 * Fetched uncached on every request.
 */
...
export async function fetchBBQuotes(): Promise<BBSnapshot> {
